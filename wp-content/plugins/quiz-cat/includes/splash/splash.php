...
function fca_qc_render_splash_page() {
	...
	wp_enqueue_style('fca_qc_splash_css', FCA_QC_PLUGINS_URL . '/includes/splash/splash.min.css', false, FCA_QC_PLUGIN_VER );
	wp_enqueue_script('fca_qc_splash_js', FCA_QC_PLUGINS_URL . '/includes/splash/splash.min.js', false, FCA_QC_PLUGIN_VER, true );
